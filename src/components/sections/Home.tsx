...
import { Github, Linkedin, Instagram, Mail, Terminal, FileText, Database, ShieldCheck, Code2, Cpu } from "lucide-react";
  ...
  return (
    <section id="home" className="min-h-screen flex items-center pt-20 relative overflow-hidden bg-white dark:bg-black">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="z-10 lg:-mt-24">
          ...
          <h1 className="text-5xl md:text-8xl font-black tracking-tighter leading-[0.85] mb-8 text-black dark:text-white">
            <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="block">
              FULLSTACK
            </motion.span>
            <motion.span initial={{ width: 0 }} animate={{ width: "100%" }} transition={{ duration: 1.5, ease: "easeInOut", delay: 0.5 }} className="text-red-600 inline-block overflow-hidden whitespace-nowrap border-r-4 border-red-600">
              ENGINEER.
            </motion.span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8">
            ...
            <div className="flex items-center gap-6 text-zinc-400 dark:text-zinc-500">
              <a href="https://www.instagram.com/lam.xyz_/" className="hover:text-red-600 transition-all hover:-translate-y-1">
                <Instagram size={22} />
              </a>
              <a href="https://github.com/Lam89-Pass" className="hover:text-black dark:hover:text-white transition-all hover:-translate-y-1">
                <Github size={22} />
              </a>
              <a href="https://www.linkedin.com/in/muhamadnursalam/" className="hover:text-red-600 transition-all hover:-translate-y-1">
                <Linkedin size={22} />
              </a>
              <a href="mailto:aaallaaamm03@gmail.com@gmail.com" className="hover:text-red-600 transition-all hover:-translate-y-1">
                <Mail size={22} />
              </a>
            </div>
          </div>
        ...
        <div className="relative flex justify-center lg:justify-end items-end h-[500px] md:h-[700px]">
          <motion.div initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, ease: "easeOut" }} className="relative w-full max-w-[480px] z-10 pt-40 md:pt-56">
            <img
              src="/me.png"
              alt="Alam Profile"
